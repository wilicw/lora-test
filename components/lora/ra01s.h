...
#define SX126X_SLEEP_START_COLD                                                \
  0b00000000 //  2     2     sleep mode: cold start, configuration is lost
             //  (default)
#define SX126X_SLEEP_START_WARM                                                \
  0b00000100 //  2     2                 warm start, configuration is retained
#define SX126X_SLEEP_RTC_OFF                                                   \
  0b00000000 //  0     0     wake on RTC timeout: disabled
#define SX126X_SLEEP_RTC_ON                                                    \
  0b00000001 //  0     0                          enabled

// SX126X_CMD_SET_STANDBY
#define SX126X_STANDBY_RC                                                      \
  0x00 //  7     0     standby mode: 13 MHz RC oscillator
#define SX126X_STANDBY_XOSC                                                    \
  0x01 //  7     0                   32 MHz crystal oscillator

// SX126X_CMD_SET_RX
#define SX126X_RX_TIMEOUT_NONE                                                 \
  0x000000 //  23    0     Rx timeout duration: no timeout (Rx single mode)
#define SX126X_RX_TIMEOUT_INF                                                  \
  0xFFFFFF //  23    0                          infinite (Rx continuous mode)

// SX126X_CMD_STOP_TIMER_ON_PREAMBLE
#define SX126X_STOP_ON_PREAMBLE_OFF                                            \
  0x00 //  7     0     stop timer on: sync word or header (default)
#define SX126X_STOP_ON_PREAMBLE_ON                                             \
  0x01 //  7     0                    preamble detection

// SX126X_CMD_SET_REGULATOR_MODE
#define SX126X_REGULATOR_LDO                                                   \
  0x00 //  7     0     set regulator mode: LDO (default)
#define SX126X_REGULATOR_DC_DC 0x01 //  7     0                         DC-DC

// SX126X_CMD_CALIBRATE
#define SX126X_CALIBRATE_IMAGE_OFF                                             \
  0b00000000 //  6     6     image calibration: disabled
#define SX126X_CALIBRATE_IMAGE_ON                                              \
  0b01000000 //  6     6                        enabled
#define SX126X_CALIBRATE_ADC_BULK_P_OFF                                        \
  0b00000000 //  5     5     ADC bulk P calibration: disabled
#define SX126X_CALIBRATE_ADC_BULK_P_ON                                         \
  0b00100000 //  5     5                             enabled
#define SX126X_CALIBRATE_ADC_BULK_N_OFF                                        \
  0b00000000 //  4     4     ADC bulk N calibration: disabled
#define SX126X_CALIBRATE_ADC_BULK_N_ON                                         \
  0b00010000 //  4     4                             enabled
#define SX126X_CALIBRATE_ADC_PULSE_OFF                                         \
  0b00000000 //  3     3     ADC pulse calibration: disabled
#define SX126X_CALIBRATE_ADC_PULSE_ON                                          \
  0b00001000 //  3     3                            enabled
#define SX126X_CALIBRATE_PLL_OFF                                               \
  0b00000000 //  2     2     PLL calibration: disabled
#define SX126X_CALIBRATE_PLL_ON                                                \
  0b00000100 //  2     2                      enabled
#define SX126X_CALIBRATE_RC13M_OFF                                             \
  0b00000000 //  1     1     13 MHz RC osc. calibration: disabled
#define SX126X_CALIBRATE_RC13M_ON                                              \
  0b00000010 //  1     1                                 enabled
#define SX126X_CALIBRATE_RC64K_OFF                                             \
  0b00000000 //  0     0     64 kHz RC osc. calibration: disabled
#define SX126X_CALIBRATE_RC64K_ON                                              \
  0b00000001 //  0     0                                 enabled
...
#define SX126X_RX_TX_FALLBACK_MODE_FS                                          \
  0x40 //  7     0     after Rx/Tx go to: FS mode
#define SX126X_RX_TX_FALLBACK_MODE_STDBY_XOSC                                  \
  0x30 //  7     0                        standby with crystal oscillator
#define SX126X_RX_TX_FALLBACK_MODE_STDBY_RC                                    \
  0x20 //  7     0                        standby with RC oscillator (default)

// SX126X_CMD_SET_DIO_IRQ_PARAMS
#define SX126X_IRQ_TIMEOUT 0b1000000000 //  9     9     Rx or Tx timeout
#define SX126X_IRQ_CAD_DETECTED                                                \
  0b0100000000 //  8     8     channel activity detected
#define SX126X_IRQ_CAD_DONE                                                    \
  0b0010000000 //  7     7     channel activity detection finished
...
#define SX126X_IRQ_HEADER_VALID                                                \
  0b0000010000 //  4     4     valid LoRa header received
#define SX126X_IRQ_SYNC_WORD_VALID                                             \
  0b0000001000 //  3     3     valid sync word detected
#define SX126X_IRQ_PREAMBLE_DETECTED                                           \
  0b0000000100                          //  2     2     preamble detected
#define SX126X_IRQ_RX_DONE 0b0000000010 //  1     1     packet received
#define SX126X_IRQ_TX_DONE                                                     \
  0b0000000001 //  0     0     packet transmission completed
...
#define SX126X_DIO2_AS_RF_SWITCH                                               \
  0x01 //  7     0                         RF switch control

// SX126X_CMD_SET_DIO3_AS_TCXO_CTRL
#define SX126X_DIO3_OUTPUT_1_6                                                 \
  0x00 //  7     0     DIO3 voltage output for TCXO: 1.6 V
#define SX126X_DIO3_OUTPUT_1_7                                                 \
  0x01 //  7     0                                   1.7 V
#define SX126X_DIO3_OUTPUT_1_8                                                 \
  0x02 //  7     0                                   1.8 V
#define SX126X_DIO3_OUTPUT_2_2                                                 \
  0x03 //  7     0                                   2.2 V
#define SX126X_DIO3_OUTPUT_2_4                                                 \
  0x04 //  7     0                                   2.4 V
#define SX126X_DIO3_OUTPUT_2_7                                                 \
  0x05 //  7     0                                   2.7 V
#define SX126X_DIO3_OUTPUT_3_0                                                 \
  0x06 //  7     0                                   3.0 V
#define SX126X_DIO3_OUTPUT_3_3                                                 \
  0x07 //  7     0                                   3.3 V
...
#define SX126X_GFSK_FILTER_GAUSS_0_3                                           \
  0x08 //  7     0                  Gaussian, BT = 0.3
#define SX126X_GFSK_FILTER_GAUSS_0_5                                           \
  0x09 //  7     0                  Gaussian, BT = 0.5
#define SX126X_GFSK_FILTER_GAUSS_0_7                                           \
  0x0A //  7     0                  Gaussian, BT = 0.7
#define SX126X_GFSK_FILTER_GAUSS_1                                             \
  0x0B                             //  7     0                  Gaussian, BT = 1
...
#define SX126X_GFSK_RX_BW_117_3                                                \
  0x0B //  7     0                        117.3 kHz
#define SX126X_GFSK_RX_BW_156_2                                                \
  0x1A //  7     0                        156.2 kHz
#define SX126X_GFSK_RX_BW_187_2                                                \
  0x12 //  7     0                        187.2 kHz
#define SX126X_GFSK_RX_BW_234_3                                                \
  0x0A //  7     0                        234.3 kHz
#define SX126X_GFSK_RX_BW_312_0                                                \
  0x19 //  7     0                        312.0 kHz
#define SX126X_GFSK_RX_BW_373_6                                                \
  0x11 //  7     0                        373.6 kHz
#define SX126X_GFSK_RX_BW_467_0                                                \
  0x09                            //  7     0                        467.0 kHz
...
#define SX126X_LORA_LOW_DATA_RATE_OPTIMIZE_OFF                                 \
  0x00 //  7     0     LoRa low data rate optimization: disabled
#define SX126X_LORA_LOW_DATA_RATE_OPTIMIZE_ON                                  \
  0x01 //  7     0                                      enabled

// SX126X_CMD_SET_PACKET_PARAMS
#define SX126X_GFSK_PREAMBLE_DETECT_OFF                                        \
  0x00 //  7     0     GFSK minimum preamble length before reception starts:
       //  detector disabled
#define SX126X_GFSK_PREAMBLE_DETECT_8                                          \
  0x04 //  7     0                                                           8
       //  bits
#define SX126X_GFSK_PREAMBLE_DETECT_16                                         \
  0x05 //  7     0                                                           16
       //  bits
#define SX126X_GFSK_PREAMBLE_DETECT_24                                         \
  0x06 //  7     0                                                           24
       //  bits
#define SX126X_GFSK_PREAMBLE_DETECT_32                                         \
  0x07 //  7     0                                                           32
       //  bits
#define SX126X_GFSK_ADDRESS_FILT_OFF                                           \
  0x00 //  7     0     GFSK address filtering: disabled
#define SX126X_GFSK_ADDRESS_FILT_NODE                                          \
  0x01 //  7     0                             node only
#define SX126X_GFSK_ADDRESS_FILT_NODE_BROADCAST                                \
  0x02 //  7     0                             node and broadcast
#define SX126X_GFSK_PACKET_FIXED                                               \
  0x00 //  7     0     GFSK packet type: fixed (payload length known in advance
       //  to both sides)
#define SX126X_GFSK_PACKET_VARIABLE                                            \
  0x01 //  7     0                       variable (payload length added to
       //  packet)
...
#define SX126X_GFSK_CRC_1_BYTE_INV                                             \
  0x04 //  7     0                      1 byte, inverted
#define SX126X_GFSK_CRC_2_BYTE_INV                                             \
  0x06 //  7     0                      2 byte, inverted
#define SX126X_GFSK_WHITENING_OFF                                              \
  0x00 //  7     0     GFSK data whitening: disabled
#define SX126X_GFSK_WHITENING_ON                                               \
  0x01 //  7     0                          enabled
#define SX126X_LORA_HEADER_EXPLICIT                                            \
  0x00 //  7     0     LoRa header mode: explicit
#define SX126X_LORA_HEADER_IMPLICIT                                            \
  0x01                               //  7     0                       implicit
...
#define SX126X_CAD_ON_1_SYMB                                                   \
  0x00 //  7     0     number of symbols used for CAD: 1
#define SX126X_CAD_ON_2_SYMB                                                   \
  0x01 //  7     0                                     2
#define SX126X_CAD_ON_4_SYMB                                                   \
  0x02 //  7     0                                     4
#define SX126X_CAD_ON_8_SYMB                                                   \
  0x03 //  7     0                                     8
#define SX126X_CAD_ON_16_SYMB                                                  \
  0x04 //  7     0                                     16
#define SX126X_CAD_GOTO_STDBY                                                  \
  0x00 //  7     0     after CAD is done, always go to STDBY_RC mode
#define SX126X_CAD_GOTO_RX                                                     \
  0x01 //  7     0     after CAD is done, go to Rx mode if activity is detected

// SX126X_CMD_GET_STATUS
#define SX126X_STATUS_MODE_STDBY_RC                                            \
  0b00100000 //  6     4     current chip mode: STDBY_RC
#define SX126X_STATUS_MODE_STDBY_XOSC                                          \
  0b00110000 //  6     4                        STDBY_XOSC
...
#define SX126X_STATUS_DATA_AVAILABLE                                           \
  0b00000100 //  3     1     command status: packet received and data can be
             //  retrieved
#define SX126X_STATUS_CMD_TIMEOUT                                              \
  0b00000110 //  3     1                     SPI command timed out
#define SX126X_STATUS_CMD_INVALID                                              \
  0b00001000 //  3     1                     invalid SPI command
#define SX126X_STATUS_CMD_FAILED                                               \
  0b00001010 //  3     1                     SPI command failed to execute
#define SX126X_STATUS_TX_DONE                                                  \
  0b00001100 //  3     1                     packet transmission done
#define SX126X_STATUS_SPI_FAILED                                               \
  0b11111111 //  7     0     SPI transaction failed

// SX126X_CMD_GET_PACKET_STATUS
#define SX126X_GFSK_RX_STATUS_PREAMBLE_ERR                                     \
  0b10000000 //  7     7     GFSK Rx status: preamble error
#define SX126X_GFSK_RX_STATUS_SYNC_ERR                                         \
  0b01000000 //  6     6                     sync word error
#define SX126X_GFSK_RX_STATUS_ADRS_ERR                                         \
  0b00100000 //  5     5                     address error
#define SX126X_GFSK_RX_STATUS_CRC_ERR                                          \
  0b00010000 //  4     4                     CRC error
#define SX126X_GFSK_RX_STATUS_LENGTH_ERR                                       \
  0b00001000 //  3     3                     length error
#define SX126X_GFSK_RX_STATUS_ABORT_ERR                                        \
  0b00000100 //  2     2                     abort error
#define SX126X_GFSK_RX_STATUS_PACKET_RECEIVED                                  \
  0b00000010 //  2     2                     packet received
#define SX126X_GFSK_RX_STATUS_PACKET_SENT                                      \
  0b00000001 //  2     2                     packet sent

// SX126X_CMD_GET_DEVICE_ERRORS
#define SX126X_PA_RAMP_ERR                                                     \
  0b100000000 //  8     8     device errors: PA ramping failed
#define SX126X_PLL_LOCK_ERR                                                    \
  0b001000000 //  6     6                    PLL failed to lock
#define SX126X_XOSC_START_ERR                                                  \
  0b000100000 //  5     5                    crystal oscillator failed to start
#define SX126X_IMG_CALIB_ERR                                                   \
  0b000010000 //  4     4                    image calibration failed
#define SX126X_ADC_CALIB_ERR                                                   \
  0b000001000 //  3     3                    ADC calibration failed
#define SX126X_PLL_CALIB_ERR                                                   \
  0b000000100 //  2     2                    PLL calibration failed
#define SX126X_RC13M_CALIB_ERR                                                 \
  0b000000010 //  1     1                    RC13M calibration failed
#define SX126X_RC64K_CALIB_ERR                                                 \
  0b000000001 //  0     0                    RC64K calibration failed
...
void LoRaConfig(uint8_t spreadingFactor, uint8_t bandwidth, uint8_t codingRate,
                uint16_t preambleLength, uint8_t payloadLen, bool crcOn,
                bool invertIrq);
...
void SetCadParams(uint8_t cadSymbolNum, uint8_t cadDetPeak, uint8_t cadDetMin,
